Wiki Generator + Save to Google Drive
======================================

What Other Wiki's do not provide we do
--------------------------------------
- Social Network of Wiki writers.
- people can up or downvote wiki.
- people can make public or private wiki (can share to only a circle and those people can change, see , up or downvote) a better than most wiki platforms.
- while making pages a person will have the save button like blogger or wordpress to save the page as draft also the page will be saved every 1 minute 30 seconds time interval so to act as reliable during sudden power cuts.
- The direct messages should be integrated just like facebook.
- Use Google Drive REST API (Python Client API or JavaScript Client API for Google Drive Sign in) e.g gplus-python-client-quickstart in ~/Documents/Google_App_Engine/GoogleAPIs , signing like interviewstreet.
- preview of the page should be there.
- use KnockoutJS, sammy.js to load pages using JavaScript at particular event.
